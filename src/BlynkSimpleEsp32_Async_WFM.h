...
// -- HTML page fragments
const char BLYNK_WM_HTML_HEAD[]     /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>Blynk_Async_Esp32_WFM</title><style>div,input{padding:2px;font-size:1em;}input{width:95%;}\
